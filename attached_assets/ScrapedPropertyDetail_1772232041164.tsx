...
export default function ScrapedPropertyDetail() {
  ...
  const amenities = Array.isArray(displayProperty.amenities) ? displayProperty.amenities as string[] : [];
                ...
                <Card>
                  <CardHeader className="py-3">
                    <CardTitle className="text-sm flex items-center gap-2">
                      ...
                      Amenities
                      <Badge variant="secondary" className="ml-auto text-xs">{amenities.length}</Badge>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="pt-0">
                    <div className="flex flex-wrap gap-2">
                      {amenities.map((amenity, i) => (
                        <Badge key={i} variant="outline">{String(amenity)}</Badge>
                      ))}
                    </div>
                  </CardContent>
                </Card>
