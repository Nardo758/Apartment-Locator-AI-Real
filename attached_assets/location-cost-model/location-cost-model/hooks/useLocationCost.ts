...
export function useMockApartments(): MockApartment[] {
  return useMemo(() => [
    {
      id: 'apt-1',
      name: 'The Vue at Lake Eola',
      address: '101 E Pine St, Orlando, FL 32801',
      coordinates: { lat: 28.5420, lng: -81.3729 },
      baseRent: 1850,
    ...
    {
      id: 'apt-2',
      name: 'Camden Orange Court',
      address: '601 N Orange Ave, Orlando, FL 32801',
      coordinates: { lat: 28.5478, lng: -81.3792 },
      baseRent: 1650,
    ...
    {
      id: 'apt-3',
      name: 'Millenia Apartments',
      address: '4950 Millenia Blvd, Orlando, FL 32839',
      coordinates: { lat: 28.4859, lng: -81.4284 },
      baseRent: 1450,
      parkingIncluded: true,
      bedrooms: 1,
      bathrooms: 1,
    ...
    },
    {
      id: 'apt-4',
      name: 'Baldwin Harbor',
      address: '4225 S John Young Pkwy, Orlando, FL 32839',
      coordinates: { lat: 28.4612, lng: -81.4098 },
      baseRent: 1350,
      parkingIncluded: true,
      bedrooms: 1,
      bathrooms: 1,
    ...
    {
      id: 'apt-5',
      name: 'ARIUM MetroWest',
      address: '2300 S Hiawassee Rd, Orlando, FL 32835',
      coordinates: { lat: 28.5089, lng: -81.4567 },
      baseRent: 1275,
      parkingIncluded: true,
      bedrooms: 1,
      bathrooms: 1,
