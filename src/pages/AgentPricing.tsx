      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className={`text-lg ${billingCycle === 'annual' ? 'text-white font-semibold' : 'text-white/60'}`}>
              Annual
            </span>
            {billingCycle === 'annual' && (
            ...
            >
              ...
              <CardHeader className="pt-8">
                <div className="flex items-center gap-2 mb-2">
                  {plan.id === 'brokerage' && <Crown className="w-5 h-5 text-yellow-400" />}
                  {plan.id === 'team' && <Users className="w-5 h-5 text-purple-400" />}
                  {plan.id === 'agent' && <User className="w-5 h-5 text-blue-400" />}
              ...
              <CardContent className="space-y-6">
                ...
                {plan.notIncluded.length > 0 && (
                  <div className="space-y-3 pt-4 border-t border-white/10">
                    <p className="text-sm font-semibold text-white/50">Not included:</p>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Powerful Features for Agents</h2>
            <p className="text-white/70 text-lg">Everything you need to manage your real estate business</p>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Trusted by Top Agents</h2>
            <p className="text-white/70 text-lg">See what industry professionals are saying</p>
          </div>
        ...
        {/* ROI Calculator */}
        <Card variant="highlighted" className="mb-20">
            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white/5 rounded-lg p-6">
                  <p className="text-4xl font-bold text-green-400 mb-2">$6,300</p>
                  <p className="text-white/60">Avg. commission per deal</p>
                </div>
                <div className="bg-white/5 rounded-lg p-6">
                  <p className="text-4xl font-bold text-purple-400 mb-2">$79</p>
                  <p className="text-white/60">Monthly platform cost</p>
                </div>
                <div className="bg-white/5 rounded-lg p-6">
                  <p className="text-4xl font-bold text-yellow-400 mb-2">79x</p>
