    ...
    Tables: {
      ...
      market_predictions: {
        Row: {
          ...
          predicted_price_change_30d: number | null
          predicted_price_change_90d: number | null
      ...
      scraping_errors: {
        ...
        Relationships: [
          {
            foreignKeyName: "scraping_errors_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
      ...
      user_preferences: {
        Row: {
          ...
          new_listing_alerts: boolean | null
          preferred_cities: Json | null
          price_drop_alerts: boolean | null
          required_amenities: Json | null
          updated_at: string | null
          user_id: string
        }
        Insert: {
