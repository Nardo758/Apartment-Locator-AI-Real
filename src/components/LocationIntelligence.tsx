...
const LocationIntelligence: React.FC<LocationIntelligenceProps> = ({ userProfile }) => {
  ...
  return (
    <div id="location-intelligence" className="glass-dark rounded-xl p-6 space-y-6">
      {/* Section Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Location Intelligence</h2>
            <p className="text-muted-foreground">Manage your points of interest and find optimized apartments</p>
          </div>
        </div>
