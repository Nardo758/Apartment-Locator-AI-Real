  ...
  const savingsContent = (
    <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="font-medium text-green-800 dark:text-green-400">Potential Savings</span>
      </div>
      <div className="grid grid-cols-2 gap-4 text-sm">
        <div>
          <p className="text-green-700 dark:text-green-300">Monthly Range</p>
        ...
        <div>
          <p className="text-green-700 dark:text-green-300">Annual Savings</p>
          <p className="font-bold text-green-800 dark:text-green-200">
        ...
        <div className="flex justify-between items-start flex-wrap gap-2">
          <div>
            ...
            <p className="text-sm text-muted-foreground flex items-center gap-1">
              ...
              Unit {apartmentIQData.unitNumber} &bull; {apartmentIQData.bedrooms}BR/{apartmentIQData.bathrooms}BA
            </p>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-between" data-testid="display-deal-score">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 text-sm" data-testid="display-key-metrics">
            ...
            <div data-testid="section-potential-savings">
              {savingsContent}
            </div>

            <div className="flex items-center justify-between p-3 rounded-lg border" data-testid="display-timing-advice">
              <div className="flex items-center gap-2">
            ...
            {!compact && (
              <>
                {dealIntelligence.negotiationTips.length > 0 && (
                  <div className="space-y-2" data-testid="display-negotiation-tips">
                    <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between text-sm" data-testid="display-landlord-status">
